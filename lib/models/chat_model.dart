...
class ChatModel extends HiveObject {
  ...
  @HiveField(2) String modelId;
  @HiveField(3) String systemPrompt;
  @HiveField(4) final List<MessageModel> messages;
  @HiveField(5) final DateTime createdAt;
  @HiveField(6) DateTime updatedAt;

  ChatModel({required this.id, this.title = 'New Chat', this.modelId = '', this.systemPrompt = '', List<MessageModel>? messages, DateTime? createdAt, DateTime? updatedAt})
